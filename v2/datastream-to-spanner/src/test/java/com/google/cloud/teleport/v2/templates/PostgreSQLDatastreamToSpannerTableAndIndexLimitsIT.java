...
public class PostgreSQLDatastreamToSpannerTableAndIndexLimitsIT extends DataStreamToSpannerITBase {

  private static final Logger LOG =
      LoggerFactory.getLogger(PostgreSQLDatastreamToSpannerTableAndIndexLimitsIT.class);

  private static final String POSTGRESQL_DDL_RESOURCE =
      "PostgreSQLTableAndIndexLimitsIT/postgresql-schema.sql";
  private static final String SPANNER_DDL_RESOURCE =
      "PostgreSQLTableAndIndexLimitsIT/spanner-schema.sql";
  ...
  public void setUp() throws IOException {
    ...
    synchronized (PostgreSQLDatastreamToSpannerTableAndIndexLimitsIT.class) {
      ...
      if (jobInfo == null) {
        ...
        jobInfo =
            launchDataflowJob(
                "postgresql-table-and-index-limits",
                null,
                null,
  ...
  public static void cleanUp() throws IOException {
    ...
    for (PostgreSQLDatastreamToSpannerTableAndIndexLimitsIT instance : testInstances) {
